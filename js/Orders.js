...
//         productCard.dataset.pro_id = product.product.pro_id;

//         const productName = document.createElement("h4");
//         productName.className = "product-name";
//         productName.textContent = product.product.pro_name;
...
//         productPrice.textContent = `Rs${product.product.price}`;

//         const productCount = document.createElement("span");
//         productCount.className = "product-count";
//         productCount.textContent = `${product.product.quantity} Products`;
//         productCount.dataset.quantity = product.product.quantity;
...
//             addProductToCart(product.product,productCount)
//         );
//     });
// }
...
//     const product = cart[productIndex];
//     const productCountElement = document.quarySelector(`.product-card[data-product-pro_id='${pro_id}'].product-count`);
...
//         const productTotalPrice = cartProduct * cartProduct.quantity;
